...
public class VorbisEncoder {
	...
	public void encode(File input, File output) {
		...
		if (!encoder.vorbis_encode_init_vbr(vi, 2, 44100, .3f))
			throw new IllegalStateException("Failed to Initialize vorbisenc");
		...
		if ( !vd.vorbis_analysis_init( vi ) )
			throw new IllegalStateException("Failed to Initialize vorbis_dsp_state");
